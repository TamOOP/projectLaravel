            ...
            <div class="col-12">
                <div class="card card-info">
                    <div class="card-header">
                        <form method="get" action="{{ route('a.d.del.red') }}" style="width: 50%;">
                  ...
                  <tbody>
                      ...
                      <tr>
                          ...
                          <a style="width: 40%; float: left;">
                              ...
                              <a style="width: 40%; float: right;">
                                <button type="button" class="btn btn-block btn-warning" onclick="deleteDiscount(this)" data-did="{{ $discount->discount_id }}">Delete</button>
                            </a> 
                          @endif
                          </td>
                      </tr>
...
function deleteDiscount(button){
    if(confirm('Bạn có chắc muốn xóa khuyến mại này không')){
        ...
        $.ajax({
            ...
            data: formData,
            success: function (response) {
                alert('Discount no.' + did + ' has been deleted.');
                window.location.reload();
            },
            error:function(response){
                alert("An error when deactivating discount!");
        ...
        alert('You should change no longer used discounts to new ones instead of deleting them.')
    }
}
</script>
</body>
