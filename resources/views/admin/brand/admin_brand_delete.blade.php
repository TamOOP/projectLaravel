            ...
            <div class="col-12">
                <div class="card card-info">
                    <div class="card-header">
                        <form method="get" action="{{ route('a.b.del.red') }}" style="width: 50%;">
                        ...
                        <br>
                        <h3 class="card-title">Click on brand to see more details. Deactivate brands in order to delete</h3>
                    </div>
                    <div class="card-body">
...
function deleteBrand(button){
    if(confirm('All products of this brand will be deactivated until you change their brands and status.\nYou can not use this brand\'s id in the future.\nAre you sure want to delete this brand?')){
        var bid = button.getAttribute("data-bid");
        var formData = new FormData();
        formData.append('bid', bid);
        $.ajax({
        ...
        alert('You should change no longer used brands to new ones instead of deleting them.')
    }
}
