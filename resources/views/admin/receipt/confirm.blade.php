              ...
              <div class="col-12">
                  <div class="card card-info">
                      <div class="card-header">
                          <form method="get" action="{{ route('a.r.list.1') }}" style="width: 50%;">
                          ...
                          <br>
                        <h3 class="card-title">Nhập ngày đã xác thực để tìm kiếm</h3>
          ...
          <tbody>
              @foreach($receipts as $receipt)
                  <tr>
                      ...
                      <td valign="middle"><td valign="middle"><b style="color: green;">Đã xác nhận</b></td></td>
                                            @else
                                            <td valign="middle">Chưa xác nhận</td>
                                            @endif
                      
                      <td valign="middle">{{$receipt->mem_id}}</td>
                      <td valign="middle">{{$receipt->staff_id}}</td>
                      <td valign="middle"><a class="btn btn-primary mr-2" href="/admin/detail/{{$receipt->receipt_id}}"><i class="fa fa-edit"></i></a></td>
