              ...
              <div class="col-12">
                  <div class="card card-info">
                      <div class="card-header">
                          <form method="get" action="{{ route('a.r.list.3') }}" style="width: 50%;">
          ...
          <tbody>
              @foreach($receipts as $receipt)
                  <tr>
                      ...
                      <td valign="middle"><td valign="middle"><b style="color: green;">Đã hoàn thành</b></td></td>
